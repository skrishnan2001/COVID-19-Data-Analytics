...
# The below code returns a dataframe which includes the cumulative active,recovered,deceased and total cases for Tamil Nadu
...
def plotGraph1():
    ...
    ax.set_title('Tamil Nadu State – Total, Active, Recovered Cases & Deaths:' + " " + pd.Timestamp("today").strftime(
    ...
    ax1.legend(bbox_to_anchor=(0., -0.2, 1., .102), loc=3,
               ncol=5, mode="expand", borderaxespad=0.)
    plt.savefig('./images/Tamil Nadu State – Total, Active, Recovered Cases & Deaths.png', bbox_inches='tight')
    plt.close()
...
def plotGraph2():
    ...
    plt.savefig('./images/Tamil Nadu State – Total vs Active Cases.png', bbox_inches='tight')
    plt.close()
...
def plotGraph3():
    ...
    ax.legend(['Total ' + str(data['Total'][data['Total'].index[-1]]),
              ...
              loc=3,
              ncol=5, mode="expand", borderaxespad=0.)
    plt.savefig('./images/Tamil Nadu State – Total vs Recovered Cases.png', bbox_inches='tight')
    plt.close()
...
def plotGraph4():
    ...
    ax1.legend(bbox_to_anchor=(0., -0.2, 1., .102), loc=3,
               ncol=5, mode="expand", borderaxespad=0.)
    plt.savefig('./images/Tamil Nadu State – Total, Active Cases and Doubling Time.png', bbox_inches='tight')
...
def plotGraph5():
    ...
    ax.set_title('Tamil Nadu State –  Active Rate, Recovered Rate & Death rate:' + " " + pd.Timestamp("today").strftime(
        "%d/%m/%Y"), fontweight='bold', fontsize=20)
    ...
    ax1.legend(bbox_to_anchor=(0., -0.2, 1., .102), loc=3,
               ncol=5, mode="expand", borderaxespad=0.)
    plt.savefig('./images/Tamil Nadu State –  Active Rate, Recovered Rate & Death rate.png', bbox_inches='tight')
    plt.close()
...
def plotGraph6():
    ...
    plt.savefig('./images/Tamil Nadu State – Traffic Intensity.png', bbox_inches='tight')
    plt.close()
...
def plotGraph7():
    ...
    ax.xaxis.set_major_locator(loc)
    ax.xaxis.set_minor_locator(loc1)
    plt.savefig('./images/COVID-19 Cumulative Graphs for Chennai.png', bbox_inches='tight')
    plt.close()
...
def plotGraph8():
    ...
    plt.savefig('./images/Daily new cases for Chennai.png', bbox_inches='tight')
    plt.close()
...
def plotGraph9():
    ...
    ax.legend(bbox_to_anchor=(0., -0.17, 1., .102), loc=3,
              ncol=5, mode="expand", borderaxespad=0.)
    plt.savefig('./images/Percentage Change in Daily Active Cases.png', bbox_inches='tight')
    plt.close()
...
def plotGraph10():
    ...
    ax.set_title(
        'Chennai –  Active Rate, Recovered Rate & Death rate:' + " " + pd.Timestamp("today").strftime("%d/%m/%Y"),
        fontweight='bold', fontsize=20)
    ax.set_ylabel(' Active and Recovered Rates', fontweight='bold', fontsize=15)
    ax1.set_ylabel('Death rate', fontweight='bold', fontsize=15)
    ax.set_xlabel('Dates', fontweight='bold', fontsize=15)
    ...
    ax1.legend(bbox_to_anchor=(0., -0.2, 1., .102), loc=3,
               ncol=5, mode="expand", borderaxespad=0.)
    plt.savefig('./images/Chennai –  Active Rate, Recovered Rate & Death rate.png', bbox_inches='tight')
    plt.close()
...
def plotGraph11():
    ...
    plt.savefig('./images/Trend of Total Cases[1].png', bbox_inches='tight')
    plt.close()
...
def plotGraph16():
    ...
    y_l = 'Active Cases'
    district_set1(x, y1, y2, y3, y4, y5, y6, y7, head, x_l, y_l, label1, label2, label3, label4, label5, label6, label7)
    plt.savefig('./images/Trend of Active Cases[1].png', bbox_inches='tight')
    plt.close()
...
def plotGraph21():
    ...
    y_l = 'Recovered Cases'
    district_set1(x, y1, y2, y3, y4, y5, y6, y7, head, x_l, y_l, label1, label2, label3, label4, label5, label6, label7)
    plt.savefig('./images/Trend of Recovered Cases[1].png', bbox_inches='tight')
    plt.close()
...
def plotGraph12():
    ...
    y_l = 'Count of Total Cases'
    district_set1(x, y1, y2, y3, y4, y5, y6, y7, head, x_l, y_l, label1, label2, label3, label4, label5, label6, label7)
    plt.savefig('./images/Trend of Total Cases[2].png', bbox_inches='tight')
    plt.close()
...
def plotGraph17():
    ...
    y_l = 'Active Cases'
    district_set1(x, y1, y2, y3, y4, y5, y6, y7, head, x_l, y_l, label1, label2, label3, label4, label5, label6, label7)
    plt.savefig('./images/Trend of Active Cases[2].png', bbox_inches='tight')
    plt.close()
...
def plotGraph22():
    ...
    y_l = 'Recovered Cases'
    district_set1(x, y1, y2, y3, y4, y5, y6, y7, head, x_l, y_l, label1, label2, label3, label4, label5, label6, label7)
    plt.savefig('./images/Trend of Recovered Cases[2].png', bbox_inches='tight')
    plt.close()
...
def plotGraph13():
    ...
    y_l = 'Count of Total Cases'
    district_set1(x, y1, y2, y3, y4, y5, y6, y7, head, x_l, y_l, label1, label2, label3, label4, label5, label6, label7)
    plt.savefig('./images/Trend of Total Cases[3].png', bbox_inches='tight')
    plt.close()
...
def plotGraph18():
    ...
    y_l = 'Active Cases'
    district_set1(x, y1, y2, y3, y4, y5, y6, y7, head, x_l, y_l, label1, label2, label3, label4, label5, label6, label7)
    plt.savefig('./images/Trend of Active Cases[3].png', bbox_inches='tight')
    plt.close()
...
def plotGraph23():
    ...
    y_l = 'Recovered Cases'
    district_set1(x, y1, y2, y3, y4, y5, y6, y7, head, x_l, y_l, label1, label2, label3, label4, label5, label6, label7)
    plt.savefig('./images/Trend of Recovered Cases[3].png', bbox_inches='tight')
    plt.close()
...
def plotGraph14():
    ...
    district_set2(x, y1, y2, y3, y4, y5, y6, y7, y8, head, x_l, y_l, label1, label2, label3, label4, label5, label6,
                  label7, label8)
    plt.savefig('./images/Trend of Total Cases[4].png', bbox_inches='tight')
    plt.close()
...
def plotGraph19():
    ...
    district_set2(x, y1, y2, y3, y4, y5, y6, y7, y8, head, x_l, y_l, label1, label2, label3, label4, label5, label6,
                  label7, label8)
    plt.savefig('./images/Trend of Active Cases[4].png', bbox_inches='tight')
    plt.close()
...
def plotGraph24():
    ...
    district_set2(x, y1, y2, y3, y4, y5, y6, y7, y8, head, x_l, y_l, label1, label2, label3, label4, label5, label6,
                  label7, label8)
    plt.savefig('./images/Trend of Recovered Cases[4].png', bbox_inches='tight')
    plt.close()
...
def plotGraph15():
    ...
    y_l = 'Count of Total Cases'
    district_set1(x, y1, y2, y3, y4, y5, y6, y7, head, x_l, y_l, label1, label2, label3, label4, label5, label6, label7)
    plt.savefig('./images/Trend of Total Cases[5].png', bbox_inches='tight')
    plt.close()
...
def plotGraph20():
    ...
    y_l = 'Active Cases'
    district_set1(x, y1, y2, y3, y4, y5, y6, y7, head, x_l, y_l, label1, label2, label3, label4, label5, label6, label7)
    plt.savefig('./images/Trend of Active Cases[5].png', bbox_inches='tight')
    plt.close()
...
def plotGraph25():
    ...
    y_l = 'Recovered Cases'
    district_set1(x, y1, y2, y3, y4, y5, y6, y7, head, x_l, y_l, label1, label2, label3, label4, label5, label6, label7)
    plt.savefig('./images/Trend of Recovered Cases[5].png', bbox_inches='tight')
    plt.close()
...
def compounded_barh_plot(dist, j):
    ...
    ax.legend(bbox_to_anchor=(0., -0.12, 1., .102), loc=3,
              ncol=4, mode="expand", borderaxespad=0.)
    plt.savefig('./images/Compounded Daily Growth Rate in Total Cases' + str(j) + '.png', bbox_inches='tight')
    plt.close()
...
def plotGraph32():
    ...
    plt.savefig('./images/5-day Moving Average of % Daily changes in Total Cases [1].png', bbox_inches='tight')
    plt.close()
...
def plotGraph33():
    ...
    y_l = '5-day Moving Average(% change)'
    district_set3(df1['Date'], y1, y2, y3, y4, y5, y6, head, x_l, y_l, label1, label2, label3, label4, label5, label6)
    plt.savefig('./images/5-day Moving Average of % Daily changes in Total Cases [2].png', bbox_inches='tight')
    plt.close()
...
def plotGraph34():
    ...
    y_l = '5-day Moving Average(% change)'
    district_set3(df1['Date'], y1, y2, y3, y4, y5, y6, head, x_l, y_l, label1, label2, label3, label4, label5, label6)
    plt.savefig('./images/5-day Moving Average of % Daily changes in Total Cases [3].png', bbox_inches='tight')
    plt.close()
...
def plotGraph26():
    ...
    ax.legend(bbox_to_anchor=(0., -0.2, 1., .102), loc=3,
              ncol=5, mode="expand", borderaxespad=0.)
    plt.savefig(
        './images/5-day Moving Average of Daily New Cases per Lakh of Population (Population - 2020 Midyear Projection)-Top 5 Districts with Chennai.png',
        bbox_inches='tight')
    plt.close(fig)
...
def plotGraph27():
    ...
    ax.legend(bbox_to_anchor=(0., -0.2, 1., .102), loc=3,
              ncol=5, mode="expand", borderaxespad=0.)
    plt.savefig(
        './images/5-day Moving Average of Daily New Cases per Lakh of Population (Population - 2020 Midyear Projection)-Top Districts 2 to 5.png',
        bbox_inches='tight')
    plt.close(fig)
...
def plotGraph28():
    ...
    ax.legend(bbox_to_anchor=(0., -0.2, 1., .102), loc=3,
              ncol=5, mode="expand", borderaxespad=0.)
    plt.savefig(
        './images/5-day Moving Average of Daily New Cases per Lakh of Population (Population - 2020 Midyear Projection)-Top Districts 6 to 11png',
        bbox_inches='tight')
    plt.close(fig)
